...
public class UpdateQuery {
    ...
    private static final String conditionRegex = "((?:\\w+=" + valueTypes + "))";
    ...
    public static boolean executeUpdateQuery(JSONObject parsedQuery) {
        try {
            ...
            if (tableName.isEmpty() || assignments.isEmpty() || condition.isEmpty()) {
                System.out.println(errorMessage);
                return false;
            }
    ...
    public static void main(String []a) {
        runQuery("UPDATE tab1 SET col1=12.2,col2=\"done\",col3=false,col4=TRUE WHERE col5=12.6;");
    }
}
